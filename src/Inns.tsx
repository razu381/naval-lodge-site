  ...
  const InnCard = ({ inn }: { inn: typeof innsData.featured[0] }) => (
    <div className="group bg-white rounded-[1.5rem] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500 border border-ocean-100/50">
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        >
          <Heart 
            className={`w-5 h-5 transition-colors ${favorites.includes(inn.id) ? 'fill-teal-accent text-teal-accent' : 'text-ocean-400'}`} 
          />
        </button>
      </div>
      <div className="p-6">
        <h3 className="font-display text-xl font-medium text-ocean-900 mb-2">{inn.title}</h3>
        <p className="text-ocean-500 text-sm mb-4 flex items-center gap-2">
          <MapPin className="w-4 h-4 text-teal-accent" /> {inn.location}
        </p>
        <div className="flex justify-between items-center">
          <span className="text-ocean-900 font-semibold">${inn.price}<span className="text-ocean-500 font-normal text-sm">/night</span></span>
          <span className="text-sm text-teal-accent font-medium flex items-center gap-1">
            <Star className="w-4 h-4 fill-teal-accent" /> {inn.rating}
          </span>
        </div>
      </div>
    </div>
      ...
      <nav className="bg-white/80 backdrop-blur-xl border-b border-ocean-100/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <Link to="/inns" className="text-sm font-medium text-ocean-900 bg-ocean-50 px-4 py-2 rounded-lg">Inns</Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-xl border-t border-ocean-100 px-4 pt-2 pb-4 space-y-1 shadow-xl">
            ...
            <Link to="/inns" className="block px-3 py-3 text-sm font-medium text-ocean-900 bg-ocean-50 rounded-lg">Inns</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h1 className="font-display text-5xl md:text-6xl font-medium text-ocean-900 mb-4">
                Curated <span className="text-teal-accent italic">Inns & Hotels</span>
              </h1>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl">
                  <div className="text-3xl font-bold text-ocean-900">40+</div>
                  <div className="text-sm text-ocean-500">Unique Inns</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-sand-50 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-3/5">
              <h2 className="font-display text-3xl font-medium text-ocean-900 mb-4">Looking for Something Specific?</h2>
              <p className="text-ocean-600 mb-6">We also offer group bookings and corporate rates. Contact us to find the perfect inn for your needs.</p>
